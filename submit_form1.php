...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Database connection
    $mysqli = new mysqli("localhost", "aceluyta_tayo", "Dbacylta001#@^%", "aceluyta_acedb");
    ...
    try {
        ...
        // Recipients
        $mail->setFrom('mail@acelubricant.com', 'Ace Lubricant'); // Using a fixed email address for the 'From' field
