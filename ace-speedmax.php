                 ...
                 <div class="row">
                      <div class="col-sm-12 col-12 col-md-12">
                        <div class="page-title wow fadeInDown" data-wow-delay="0.1s">
                          <h1 id="top-banner__text" class="top-banner__text">ACE SPEEDMAX 85W 140</h1>
      ...
      <section class="section-products u-center-text">
        <div class="container">
          <div class="row" >
            <div class="col-sm-12">
              <div class="product">
                <img src="images/product6.png" class="product__img" alt="Ace speedmax">
                <h2 class="product__header heading-primary--main">ACE SPEEDMAX 85W 140</h2>
                <p class="product__details paragraph u-margin-bottom-big ">SPEEDMAX 85W 140 Super Gear
                   Oil is a lubricant made specifically for transmissions, transfer cases, 
