                 ...
                 <div class="row">
                      <div class="col-sm-12 col-12 col-md-12">
                        <div class="page-title">
                          <h1 id="top-banner__text" class="top-banner__text">ACE AH 68 HYDRAULIC OIL</h1>
      ...
      <section class="section-products u-center-text">
        <div class="container">
          <div class="row" >
            <div class="col-sm-12">
              <div class="product">
                <img src="images/product8.png" class="product__img" alt="Ace hydraulic">
                <h2 class="product__header heading-primary--main">ACE AH 68 HYDRAULIC OIL</h2>
                <p class="product__details paragraph u-margin-bottom-big ">is formulated to satisfy rigorous
                   operating applications with perfect control against wears and tears suitable for heavy 
