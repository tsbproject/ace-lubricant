                 ...
                 <div class="row">
                      <div class="col-sm-12 col-12 col-md-12">
                        <div class="page-title wow fadeInDown" data-wow-delay="0.1s">
                          <h1 id="top-banner__text" class="top-banner__text">ACE SUPER HD 50(4L)</h1>
      ...
      <section class="section-products u-center-text">
        <div class="container">
          <div class="row" >
            <div class="col-sm-12">
              <div class="product">
                <img src="images/product2.png" class="product__img" alt="Ace super">
                <h2 class="product__header heading-primary--main">ACE SUPER HD 50 (4L)</h2>
                <p class="product__details paragraph u-margin-bottom-big ">is a superior quality monograde lubricant
