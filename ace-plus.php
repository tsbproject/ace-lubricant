                 ...
                 <div class="row">
                      <div class="col-sm-12 col-12 col-md-12">
                        <div class="page-title wow fadeInDown" data-wow-delay="0.1s">
                          <h1 id="top-banner__text" class="top-banner__text"> ACE PLUS 20W 50</h1>
      ...
      <section class="section-products u-center-text">
        <div class="container">
          <div class="row" >
            <div class="col-sm-12">
              <div class="product">
                <img src="images/product1.png" class="product__img" alt="Ace plus">
                <h2 class="product__header heading-primary--main">ACE PLUS 20W 50</h2>
                <p class="product__details paragraph u-margin-bottom-big ">is a good quality multi grade with OEM specification.
                  It provide exceptional control of deposits, wear, oil oxidation and excellent performance in a natural aspirated
                   engines with good dispersant, detergent and soot control abilities.
                  ACE ATF DEXTRON II (Automatic transmission fluid) oil is a friction 
                  modified fluid for use on modern automatic transmission and power 
